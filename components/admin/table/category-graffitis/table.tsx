...
interface DataTableProps{
    table: TableType<CategoryGraffiti>;
    columns: ColumnDef<CategoryGraffiti>[];
}
                ...
                >
                  {isLoading ? <LoaderSpin size="xl" className="mx-auto" /> : 
                    <Button className="space-x-2" asChild>
                      <Link href={"/admin/category-graffits/add"}>
                        <MdAdd className="h-5 w-5" /> <span>Create catégorie graffiti</span>
                      </Link>
                    </Button>
                  }
                </TableCell>
