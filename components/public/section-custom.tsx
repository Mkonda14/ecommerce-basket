...
export const SectionCustom = () => {
  return (
    <section className="my-8">
        <section className="container flex justify-center items-center py-5 bg-slate-200">
            <div className="w-1/2 p-6">
                <Typographie component="h3" variant="h3" size="xl">À notre imagination</Typographie>
