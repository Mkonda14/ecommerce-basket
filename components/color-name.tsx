...
interface ColorPickerProps{
    nameCode: "colorPrimaries"  | `colorPrimaries.${number}.code`; 
    nameColor?: "colorPrimaries" |`colorPrimaries.${number}.name`;
    form: UseFormReturn<z.infer<typeof ProductSchema>>;
    key?: string;
    value?: string
}

export const ColorName = ({nameCode, nameColor="colorPrimaries", form, key, value = "#333"}: ColorPickerProps) => {
                        ...
                        <FormControl>
                            <div>
                                ...
                                <div className={ styles.popover }>
                                    ...
                                    <CompactPicker color={ state.color }  onChange={(color)=> {
